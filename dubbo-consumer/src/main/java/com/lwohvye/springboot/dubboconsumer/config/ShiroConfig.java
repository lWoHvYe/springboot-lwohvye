...
import com.lwohvye.springboot.dubboconsumer.common.shiro.CaptchaFormAuthenticationFilter;
import com.lwohvye.springboot.dubboconsumer.common.shiro.KickoutSessionControlFilter;
import com.lwohvye.springboot.dubboconsumer.common.shiro.MyShiroRealm;
...
//        关闭兼顾测试restTemplete接口的shiro拦截
        filterChainDefinitionMap.put("/cnarea/**","anon");
