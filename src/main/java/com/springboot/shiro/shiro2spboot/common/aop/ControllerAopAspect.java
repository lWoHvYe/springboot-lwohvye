 ...
 * @description 用于捕获Controller层异常，转化为失败信息，与{@link com.springboot.shiro.shiro2spboot.common.util.ResultModel}配合使用
...
public class ControllerAopAspect {
     ...
     */
    @Pointcut("execution(public com.springboot.shiro.shiro2spboot.common.util.ResultModel *(..))")
